<template>
  <view class="page">
    ...
    <view v-else class="card" @tap="onNoDevice">
      <view class="field field--row">
        <text class="label label--inline">暂无可绑定传感器</text>
        <text class="device-help">查看说明 ›</text>
      </view>
    </view>
...
function onNoDevice() {
  uni.showModal({
    title: "暂无可绑定传感器",
    content: "请先在「我 → 传感器绑定码」完成设备配网，或先从其他植物解绑传感器。",
    showCancel: false,
  });
}
